...
public class ConfigSecurity {
    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity http)
        ...
        http.csrf().disable()
                ...
                .requestMatchers("/api/v1/doctor/deduction").hasAuthority("DOCTOR")
                .requestMatchers("/api/v1/doctor/update").hasAuthority("DOCTOR")
                .requestMatchers("/api/v1/doctor/delete").hasAuthority("DOCTOR")
                .requestMatchers("/api/v1/patient/add").hasAuthority("PATIENT")
                .requestMatchers("/api/v1/patient/update").hasAuthority("PATIENT")
                .requestMatchers("/api/v1/patient/delete").hasAuthority("PATIENT")
